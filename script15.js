...
(function(canvas) { // Main function
    ...
    var textAlpha = 0; // Variabel untuk mengatur transparansi teks
    var textFadeDuration = 9; // Durasi fade in dalam detik
    var textFadeSpeed = 1 / (textFadeDuration * 60); // Kecepatan perubahan alpha (60 fps)
    ...
    function render() { // Render function
        ...
        // Menambahkan teks "Terserah" di bagian tengah canvas
        context.font = '25px Courier'; // Atur ukuran dan jenis font
        context.fillStyle = '#FFFFFF'; // Atur warna teks
        context.textAlign = 'center'; // Rata tengah
        context.textBaseline = 'middle'; // Rata tengah vertikal
        
        // Mengatur alpha teks untuk efek fade in
        context.globalAlpha = textAlpha; // Mengatur transparansi konteks
        context.fillText('beautiful grace :3', canvas.width / 2, canvas.height / 2); // Gambar teks di tengah canvas
        
        // Mengubah alpha untuk animasi fade in
        if (textAlpha < 1) {
            textAlpha += textFadeSpeed; // Menambah alpha
        }
